#!/usr/bin/env python3
"""
IT Ops Zendesk Title Suggester — suggest_titles.py
...
Optional environment variables (same as morning_report.py):
...
SAME_FILL   = PatternFill("solid", fgColor="E2EFDA")   # green — title unchanged
BETTER_FILL = PatternFill("solid", fgColor="FFF2CC")   # yellow — new suggestion
NO_DESC     = PatternFill("solid", fgColor="F2F2F2")   # grey — no description
    ...
    for i, ticket in enumerate(tickets, start=1):
        ...
        if has_desc:
            try:
                ...
                suggestion = subject   # fall back to original
        else:
            suggestion = subject
        ...
        # Brief pause to stay within Zendesk + Anthropic rate limits
        time.sleep(0.3)
